...
namespace Iproger\DeploymentProgressBar\Di\Deploy\Model\Deploy;
...
use Iproger\DeploymentProgressBar\Helper\ProgressBar;
...
class LocaleDeploy implements DeployInterface
{
     ...
     */
    public function deployFile($filePath, $area, $themePath, $locale, $module, $fullPath = null)
    {
        //exit;
        $compiledFile = '';
    ...
    {
        $this->progressBar = new ProgressBar(0, 2189);
        $this->progressBar->setPrinter($this->output);
    }
}
